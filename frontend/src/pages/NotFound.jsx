...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-[#0c1e38] flex flex-col" data-testid="not-found-page">
      <nav className="bg-[#0c1e38]/95 backdrop-blur-md border-b border-[#155a9e]">
      ...
      <main className="flex-1 flex items-center justify-center px-6">
        <div className="text-center max-w-lg">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link to="/">
              <Button className="bg-white text-[#155a9e] hover:bg-white/90 rounded-sm font-semibold px-6 h-11">
                <ChevronLeft className="w-4 h-4 mr-1" /> Back to Home
              </Button>
            </Link>
            <Link to="/service-areas">
              <Button className="bg-transparent border border-[#155a9e] hover:border-[#0077B3] text-white rounded-sm font-semibold px-6 h-11">
                Service Areas
              </Button>
            </Link>
            <Link to="/resources">
      ...
      <footer className="border-t border-[#155a9e] py-6">
