    ...
    <div className="min-h-screen bg-[#f4f7fa] flex flex-col" data-testid="not-found-page">
      ...
      <main className="flex-1 flex items-center justify-center px-6">
        <div className="text-center max-w-lg">
          ...
          <p className="stat-number text-6xl text-[#1a2b42] mb-4">404</p>
          <h1 className="text-2xl font-bold text-[#1a2b42] mb-3" style={{ fontFamily: "Outfit" }}>
            Page Not Found
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link to="/service-areas">
              <Button className="bg-transparent border border-[#dfe6ee] hover:border-[#0077B3] text-[#1a2b42] rounded-sm font-semibold px-6 h-11">
                Service Areas
              </Button>
            </Link>
            <Link to="/resources">
      ...
      <footer className="border-t border-[#dfe6ee] py-6">
