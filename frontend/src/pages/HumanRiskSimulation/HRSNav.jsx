...
export default function HRSNav({ data }) {
  return (
    <nav className="bg-[#003B71]/95 backdrop-blur-md border-b border-white/10 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-6">
          <Link to="/" data-testid="hrs-nav-home" className="text-[#94a8be] hover:text-white text-sm flex items-center gap-1">
          ...
          <button
            data-testid="hrs-nav-cta"
            onClick={() => document.getElementById("hrs-simulation")?.scrollIntoView({ behavior: "smooth" })}
          >
