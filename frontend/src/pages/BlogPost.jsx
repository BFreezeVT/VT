...
export default function BlogPost() {
  ...
  // Convert markdown-like content to JSX. Handles the common case where a "## "/"### " heading
  // is immediately followed by list items with only a single newline (no blank line) - without
  // this, the heading line + all following list lines get merged into one block and rendered as
  // raw unformatted heading text (markdown left un-rendered).
