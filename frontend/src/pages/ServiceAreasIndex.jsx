...
export default function ServiceAreasIndex() {
  return (
    <div className="min-h-screen bg-[#020812]" data-testid="service-areas-index">
      {/* Nav */}
      <nav className="bg-[#020812]/95 backdrop-blur-md border-b border-[#003B71] sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6">
            <Link to="/" data-testid="areas-nav-home" className="text-[#A0B6CD] hover:text-white text-sm transition-colors flex items-center gap-1">
      ...
      <main role="main">
        ...
        <section className="py-24 lg:py-32" aria-label="Service areas overview">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <p className="text-base md:text-lg text-[#A0B6CD] leading-relaxed max-w-3xl mb-4">
            ...
            <p className="text-sm text-[#A0B6CD]/60">Headquartered at 5929 Baker Rd, Suite 420, Minnetonka, MN 55345</p>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {cityData.map((city, i) => (
                ...
                >
                  ...
                  <p className="text-[#A0B6CD] text-sm leading-relaxed mb-4 line-clamp-2">
                    {city.subhead}
                  </p>
                  <div className="flex flex-wrap gap-1.5 mb-4">
                    {city.localIndustries.slice(0, 3).map((ind, j) => (
                      <span key={j} className="text-[10px] text-[#0077B3] border border-[#003B71] px-2 py-0.5">
                        {ind}
                      </span>
                    ))}
                  </div>
