...
export default function WhySpecializedIT() {
  return (
    <section
      ...
      className="py-12 lg:py-18 bg-[#132640]"
    >
      <div className="max-w-7xl mx-auto px-6">
        <div className="relative flex items-center justify-center mb-8"><div className="absolute inset-0 flex items-center"><div className="w-full border-t border-white/10"></div></div><span className="relative bg-[#132640] px-6 text-[#0077B3] text-xl font-bold uppercase tracking-[0.15em]">Why Specialized IT</span></div>
