...
export default function CyberGame() {
  ...
  return (
    <section id="cyber-game" data-testid="cyber-game-section" className="py-12 lg:py-18 bg-[#071122] relative blend-top-dark blend-bottom-dark">
        ...
        <div className="bg-[#001f3d] border border-[#0d4a8a] rounded-md p-6 sm:p-8 lg:p-10 animate-fade-in-up stagger-3">
          ...
          {gameState === "playing" && current && (
            <div data-testid="game-playing">
              ...
              {/* Email card */}
              <div className="bg-[#002a52] border border-[#0d4a8a] p-5 sm:p-6 mb-6">
            ...
            <div data-testid="game-results" className="text-center py-4">
              ...
              <p className="text-[#b0c4d8] text-sm mb-6">
                {score === shuffledEmails.length
                  ...
                  : "Phishing is getting harder to spot. That&rsquo;s exactly why you need experts in your corner."}
              </p>
