  ...
  return (
    <section id="intro-stats" data-testid="intro-stats-section" aria-label="Cybersecurity threat statistics" className="py-24 lg:py-32 bg-[#e9eff6] border-t border-[#c8d6e5]">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-0 border-t border-[#d0dbe8]/50">
          {stats.map((stat, i) => {
            ...
            return (
              <div
                ...
                className={`relative pt-8 pb-6 ${i < 3 ? "border-r border-[#d0dbe8]/30 hidden lg:block" : ""} ${i < 2 ? "max-lg:border-r max-lg:border-[#d0dbe8]/30" : ""} px-6 first:pl-0 last:pr-0 animate-fade-in-up stagger-${i + 3}`}
                style={{ minWidth: 0 }}
              >
        ...
        {showRanking && (
          <div data-testid="top-5-ranking" className="mt-8 pt-8 border-t border-[#d0dbe8]/50 animate-fade-in">
