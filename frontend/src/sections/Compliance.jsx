...
export default function Compliance() {
  return (
    <section id="compliance" data-testid="compliance-section" aria-label="Compliance and risk management" className="py-24 lg:py-32 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[#1a3355]/60" />
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="mb-16">
            ...
            <p className="text-[#d0dce8] text-base max-w-2xl animate-fade-in-up stagger-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-12 gap-y-8 border-t border-[#1e6bb8]/40 pt-12">
          {complianceItems.map((item, i) => (
            <div key={item.title} data-testid={`compliance-card-${i}`} className={`flex items-start gap-4 animate-fade-in-up stagger-${i + 3}`}>
              ...
              <div>
                ...
                <p className="text-[#d0dce8] text-sm leading-relaxed">{item.desc}</p>
              </div>
            </div>
          ))}
        </div>
