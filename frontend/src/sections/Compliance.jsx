    ...
    <section id="compliance" data-testid="compliance-section" aria-label="Compliance and risk management" className="py-12 lg:py-18 bg-gradient-to-b from-[#142840] to-[#112238] dark-cards relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="mb-10 text-center">
            <div className="relative flex items-center justify-center mb-10"><div className="absolute inset-0 flex items-center"><div className="w-full border-t border-white/10"></div></div><span className="relative bg-gradient-to-b from-[#142840] to-[#112238] px-6 text-[#0077B3] text-xl font-extrabold uppercase tracking-[0.15em]">Compliance &amp; Risk</span></div>
