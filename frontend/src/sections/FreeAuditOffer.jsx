...
export default function FreeAuditOffer() {
  ...
  return (
    <section
      ...
      className="py-12 lg:py-18 bg-[#0b1626] relative blend-top-dark blend-bottom-dark"
    >
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="animate-fade-in-up stagger-2">
            <div className="border border-white/10 rounded-lg p-8 lg:p-10 bg-white/5">
              {!submitted ? (
                <>
                  ...
                  <form onSubmit={(e) => {
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        className="bg-white/5 border-[#d0dbe8] text-white placeholder:text-[#94a3b8] focus:border-[#0077B3] focus:ring-1 focus:ring-[#0077B3] rounded-sm h-11"
                        required
                      />
                    </div>
                    <div>
