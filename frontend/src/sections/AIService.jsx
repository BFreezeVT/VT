  ...
  return (
    <section id="ai-service" data-testid="ai-service-section" aria-label="AI as a Service offerings" className="py-24 lg:py-32 bg-[#0f1d32] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="relative flex items-center justify-center mb-12"><div className="absolute inset-0 flex items-center"><div className="w-full border-t-2 border-white/10"></div></div><span className="relative bg-[#0f1d32] px-6 text-[#0077B3] text-sm font-bold uppercase tracking-[0.2em]">AI as a Service</span></div>
        {/* Header */}
