...
export default function AIService() {
  return (
    <section id="ai-service" data-testid="ai-service-section" aria-label="AI as a Service offerings" className="py-24 lg:py-32 bg-[#112240] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="max-w-3xl mb-16">
          ...
          <h2 data-testid="ai-service-heading" className="text-2xl sm:text-3xl lg:text-4xl font-bold tracking-tight text-white mb-6" style={{ fontFamily: "Outfit, sans-serif" }}>
            AI is transforming your industry. We make sure it doesn&rsquo;t expose you.
          </h2>
          <p className="text-[#d0dce8] text-base leading-relaxed mb-6">
          ...
          <div className="flex items-center gap-6">
            <div>
              ...
              <p className="text-xs text-[#d0dce8] mt-1">unprepared for AI-augmented threats</p>
            </div>
            ...
            <div>
              ...
              <p className="text-xs text-[#d0dce8] mt-1">of employees use unauthorized AI tools</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-12 gap-y-10 border-t border-[#1e6bb8]/50 pt-12">
