...
export default function AIService() {
  return (
    <section id="ai-service" data-testid="ai-service-section" aria-label="AI as a Service offerings" className="py-24 lg:py-32 bg-[#0c1e38] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="max-w-3xl mb-16">
          ...
          <p className="text-[#c0d0e0] text-base leading-relaxed mb-6">
          ...
          <div className="flex items-center gap-6">
            <div>
              ...
              <p className="text-xs text-[#c0d0e0] mt-1">unprepared for AI-augmented threats</p>
            </div>
            <div className="w-px h-12 bg-[#155a9e]/50" />
            <div>
              <p className="stat-number text-3xl sm:text-4xl text-white">68<span className="text-[#0077B3]">%</span></p>
              <p className="text-xs text-[#c0d0e0] mt-1">of employees use unauthorized AI tools</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-12 gap-y-10 border-t border-[#155a9e]/50 pt-12">
