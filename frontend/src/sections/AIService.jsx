...
export default function AIService() {
  return (
    <section id="ai-service" data-testid="ai-service-section" aria-label="AI as a Service offerings" className="py-24 lg:py-32 bg-[#122640] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="max-w-3xl mb-16">
          ...
          <div className="flex items-center gap-6">
            <div>
              ...
              <p className="text-xs text-[#a0b4c8] mt-1">unprepared for AI-augmented threats</p>
            </div>
            ...
            <div>
              ...
              <p className="text-xs text-[#a0b4c8] mt-1">of employees use unauthorized AI tools</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-12 gap-y-10 border-t border-[#1e3a56]/50 pt-12">
          {aiServices.map((svc, i) => (
            <div key={svc.title} data-testid={`ai-card-${i}`} className={`animate-fade-in-up stagger-${(i % 6) + 1}`}>
              ...
              <p className="text-[#a0b4c8] text-sm leading-relaxed">{svc.desc}</p>
            </div>
          ))}
        </div>
      </div>
