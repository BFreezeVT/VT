  ...
  return (
    <section id="ai-service" data-testid="ai-service-section" aria-label="AI as a Service offerings" className="py-16 lg:py-24 bg-gradient-to-b from-[#dce6f0] to-[#c8d6e5] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="relative flex items-center justify-center mb-8"><div className="absolute inset-0 flex items-center"><div className="w-full border-t-2 border-[#a0b4c8]"></div></div><span className="relative bg-gradient-to-b from-[#dce6f0] to-[#c8d6e5] px-6 text-white text-xl font-extrabold uppercase tracking-[0.15em]">AI as a Service</span></div>
        {/* Header */}
