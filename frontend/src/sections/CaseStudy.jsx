...
export default function CaseStudy() {
  ...
  return (
    <section
      ...
      className="py-12 lg:py-18 bg-[#0d1c34]"
    >
        ...
        <div className="px-10 lg:px-14">
          ...
          >
            ...
            <CarouselPrevious
              ...
              className="border-white/10 bg-[#0d1c34] text-white hover:bg-[#0077B3] hover:border-[#0077B3] hover:text-white -left-5 lg:-left-7"
            />
            <CarouselNext
              data-testid="carousel-next"
              className="border-white/10 bg-[#0d1c34] text-white hover:bg-[#0077B3] hover:border-[#0077B3] hover:text-white -right-5 lg:-right-7"
            />
          </Carousel>
        </div>
