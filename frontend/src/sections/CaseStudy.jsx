...
export default function CaseStudy() {
  return (
    <section
      ...
      className="py-24 lg:py-32 bg-[#112240]"
    >
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-[#d0dce8] text-base max-w-2xl mx-auto animate-fade-in-up stagger-2">
        ...
        <div className="px-10 lg:px-14">
          ...
          >
              ...
              {testimonials.map((t, i) => (
                ...
                >
                  ...
                  >
                    ...
                    <p className="text-[#d0dce8] text-sm leading-relaxed mb-6 flex-1 italic">
                      &ldquo;{t.quote}&rdquo;
                    </p>
                    <div className="border-t border-[#1e6bb8] pt-4 mt-auto flex items-center gap-3">
                      {t.photo ? (
                        <img
                          src={t.photo}
                          alt={t.name}
                          className="w-10 h-10 rounded-full object-cover border border-[#1e6bb8]"
                          loading="lazy"
                        />
                      ) : (
                      ...
                      <div>
                        ...
                        <p className="text-[#d0dce8] text-xs">
                          {t.title}, {t.company}
                        </p>
                      </div>
                    </div>
            ...
            <CarouselPrevious
              ...
              className="border-[#1e6bb8] bg-[#1a3355] text-white hover:bg-[#0077B3] hover:border-[#0077B3] hover:text-white -left-5 lg:-left-7"
            />
            <CarouselNext
              data-testid="carousel-next"
              className="border-[#1e6bb8] bg-[#1a3355] text-white hover:bg-[#0077B3] hover:border-[#0077B3] hover:text-white -right-5 lg:-right-7"
            />
          </Carousel>
        </div>

        {/* Stats — open divider layout */}
        <div className="mt-16 grid grid-cols-2 sm:grid-cols-4 gap-0 border-t border-[#1e6bb8]/50 pt-8">
          <div data-testid="case-study-metric-0" className="text-center px-4">
            <p className="stat-number text-5xl text-white">60+</p>
            <p className="text-xs text-[#d0dce8] mt-1">Active Clients</p>
          </div>
          <div data-testid="case-study-metric-1" className="text-center px-4 border-l border-[#1e6bb8]/30">
            <p className="stat-number text-5xl text-white">32</p>
            <p className="text-xs text-[#d0dce8] mt-1">Years Longest Partnership</p>
          </div>
          <div data-testid="case-study-metric-2" className="text-center px-4 border-l border-[#1e6bb8]/30">
            <p className="stat-number text-5xl text-[#0077B3]">24/7</p>
            <p className="text-xs text-[#d0dce8] mt-1">Support Availability</p>
          </div>
          <div data-testid="case-study-metric-3" className="text-center px-4 border-l border-[#1e6bb8]/30">
            <p className="stat-number text-5xl text-white">4.9</p>
            <p className="text-xs text-[#d0dce8] mt-1">Average Client Rating</p>
          </div>
        </div>
      </div>
    </section>
