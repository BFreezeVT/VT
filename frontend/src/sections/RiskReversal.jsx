          ...
          <div className="animate-fade-in-up">
            <div className="relative overflow-hidden border border-[#FF5722]/20">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                ...
                <p className="text-[#003B71] text-sm">The average breach costs 9 months of exposure and millions in damages. Prevention costs a fraction.</p>
              </div>
            </div>
          </div>
          ...
          <div className="animate-fade-in-up stagger-1">
            <div className="grid-border-card p-10 relative">
              ...
              <h2
                ...
                className="text-2xl sm:text-3xl font-bold tracking-tight text-[#003B71] mb-4"
              ...
              >
                If you don&rsquo;t find at least <span className="text-[#003B71] font-semibold">three actionable improvements</span> from 
