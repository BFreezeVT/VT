          ...
          {industries.map((ind, i) => (
            ...
            >
              <div className="flex items-start gap-4 mb-5">
                <div className="w-12 h-12 flex-shrink-0 flex items-center justify-center border border-[#003B71] bg-[#020812] group-hover:border-[#0077B3] transition-colors">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {ind.highlights.map((h) => (
                  <span
                    key={h}
                    className="text-xs font-medium text-[#0077B3] border border-[#003B71] bg-[#0077B3]/5 px-3 py-1"
                  >
                    {h}
                  </span>
                ))}
