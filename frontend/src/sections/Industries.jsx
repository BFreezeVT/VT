...
export default function Industries() {
  return (
    <section
      ...
      className="py-12 lg:py-18 bg-gradient-to-b from-[#3a5a78] to-[#1e3350]"
    >
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-10">
          <div className="relative flex items-center justify-center mb-10"><div className="absolute inset-0 flex items-center"><div className="w-full border-t border-white/10"></div></div><span className="relative bg-gradient-to-b from-[#3a5a78] to-[#1e3350] px-6 text-[#0077B3] text-xl font-bold uppercase tracking-[0.15em]">Industries We Serve</span></div>
          <h2
          ...
          {industries.map((ind, i) => (
            ...
            >
              <div className="flex items-start gap-4 mb-5">
                <div className="w-12 h-12 flex-shrink-0 flex items-center justify-center border border-white/10 bg-gradient-to-b from-[#3a5a78] to-[#1e3350] group-hover:border-[#0077B3] transition-colors">
