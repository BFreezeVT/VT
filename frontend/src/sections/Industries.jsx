...
export default function Industries() {
  return (
    <section
      ...
      className="py-24 lg:py-32 bg-[#1a3355]/30"
    >
          ...
          {industries.map((ind, i) => (
            ...
            >
              <div className="flex items-start gap-4 mb-5">
                <div className="w-12 h-12 flex-shrink-0 flex items-center justify-center border border-[#1e6bb8] bg-[#112240] group-hover:border-[#0077B3] transition-colors">
              ...
              <p className="text-[#d0dce8] text-sm leading-relaxed mb-5">{ind.desc}</p>
              <div className="flex flex-wrap gap-2 mb-4">
                {ind.highlights.map((h) => (
                  <span
                    key={h}
                    className="text-xs font-medium text-[#0077B3] border border-[#1e6bb8] bg-[#0077B3]/5 px-3 py-1"
                  >
                    {h}
                  </span>
                ))}
