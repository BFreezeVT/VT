...
export default function OurApproach() {
  return (
    <section id="approach" data-testid="approach-section" aria-label="Our managed IT approach" className="py-16 lg:py-24 bg-[#0f1d32] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="relative flex items-center justify-center mb-12"><div className="absolute inset-0 flex items-center"><div className="w-full border-t border-white/10"></div></div><span className="relative bg-[#0f1d32] px-6 text-[#0077B3] text-xl font-bold uppercase tracking-[0.15em]">Our Approach</span></div>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <p className="text-[#94a8be] text-base leading-relaxed mb-12 animate-fade-in-up stagger-2">
            ...
            <div className="space-y-8">
              {approaches.map((a, i) => (
                <div key={a.title} data-testid={`approach-card-${i}`} className={`flex items-start gap-5 animate-fade-in-up stagger-${i + 3}`}>
                  <div className="w-11 h-11 flex-shrink-0 flex items-center justify-center border border-white/10 bg-white mt-0.5">
                  ...
                  <div>
                    ...
                    <p className="text-[#94a8be] text-sm leading-relaxed">{a.desc}</p>
                  </div>
                </div>
              ))}
            </div>
