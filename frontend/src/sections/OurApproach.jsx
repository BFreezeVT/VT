...
export default function OurApproach() {
  return (
    <section id="approach" data-testid="approach-section" aria-label="Our managed IT approach" className="py-24 lg:py-32 bg-[#f1f5f9] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          {/* Left — content */}
          <div>
            <p className="overline text-[#0077B3] mb-4 animate-fade-in-up">Our Approach</p>
            <h2 data-testid="approach-heading" className="text-2xl sm:text-3xl lg:text-4xl font-bold tracking-tight text-[#003B71] mb-6 animate-fade-in-up stagger-1" style={{ fontFamily: "Outfit, sans-serif" }}>
              Proactive protection built for operational industries.
            </h2>
            <p className="text-[#64748b] text-base leading-relaxed mb-12 animate-fade-in-up stagger-2">
            ...
            <div className="space-y-8">
              {approaches.map((a, i) => (
                <div key={a.title} data-testid={`approach-card-${i}`} className={`flex items-start gap-5 animate-fade-in-up stagger-${i + 3}`}>
                  <div className="w-11 h-11 flex-shrink-0 flex items-center justify-center border border-[#e2e8f0] bg-[#f1f5f9] mt-0.5">
                    <a.icon className="w-5 h-5 text-[#0077B3]" />
                  </div>
                  <div>
                    <h3 className="text-[#003B71] font-semibold text-base mb-1.5" style={{ fontFamily: "Outfit" }}>{a.title}</h3>
          ...
          <div className="animate-fade-in-up stagger-2 lg:sticky lg:top-24">
            <div className="relative overflow-hidden border border-[#e2e8f0]">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-5">
                ...
                <p className="text-[#003B71] text-sm">Our SOC team watches your infrastructure around the clock.</p>
              </div>
            </div>
          </div>
        </div>
