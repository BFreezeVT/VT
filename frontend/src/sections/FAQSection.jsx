...
const faqs = [
  ...
  },
  {
    ...
    a: "Three things: industry specialization, AI-powered security, and local presence. We don't do generic IT. Every engagement is built on sector-specific knowledge of your industry's regulations, tools, and threats. Our SOC uses machine learning for 24/7 threat detection. And we're headquartered in Minnetonka, MN with on-site response across the Twin Cities metro.",
  },
  {
